...
We define the accuracy as the error of singular values using results of `RSpectra::svds` as truth. For all RSVD, let's restrict the number of epochs as 7, i.e. how many times the whole matrix is read through if it can only be hold on disk. 
