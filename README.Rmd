...
- **sSVD**: single pass randomized singular value decomposition with power iterations
...
par(mar = c(5, 5, 2, 2))
plot(s0$d-s1$d, ylim = c(0, 15), xlab = "PC index", ylab = "Error of singular values", cex = 2, cex.lab = 2)
